...
// Export Firestore, Auth, and Storage functions
export { db, auth, collection, addDoc, getDocs, doc, updateDoc, deleteDoc, onSnapshot, storage, ref, uploadBytes, getDownloadURL };
