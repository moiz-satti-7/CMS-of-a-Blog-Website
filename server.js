...
//   const { type, title, category, subscribers } = req.body;
...
//         text: `Hello,\n\nWe have just published a new blog post titled "${title}" in the ${category} category. Check it out now!`,
//         html: `<p>Hello,</p><p>We have just published a new blog post titled <strong>${title}</strong> in the <strong>${category}</strong> category. <a href="https://dev-v2.atvandbuggy.com/?_vercel_share=ZIVIOzCMtBMX3t6u66ruikvPIkRhL41R/blog/${title.replace(/\s+/g, '-').toLowerCase()}">Read it now!</a></p>`,
//       };
